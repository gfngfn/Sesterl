...
type syntax_error = LexerError of lexer_error | ParseError of Range.t

type unification_error =
  | Contradiction
  | Inclusion of FreeID.t
  | InclusionRow of FreeRowID.t
  | InsufficientRowConstraint of {
      id : MustBeBoundRowID.t;
      given : LabelSet.t;
      required : LabelSet.t;
    }
...
type type_error =
  ...
  | InvalidNumberOfConstructorArguments of
      Range.t * constructor_name * int * int
  ...
  | MissingRequiredConstructorName of
      Range.t * constructor_name * constructor_entry
  | MissingRequiredTypeName of Range.t * type_name * type_entry
  | MissingRequiredModuleName of Range.t * module_name * module_signature
  | MissingRequiredSignatureName of
      Range.t * signature_name * module_signature abstracted
  ...
  | NotASubtypeConstructorDefinition of
      Range.t * constructor_name * constructor_entry * constructor_entry
